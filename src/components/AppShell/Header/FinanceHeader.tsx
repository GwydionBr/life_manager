...
import { alpha, getThemeColor, Group, ThemeIcon, Title, useMantineTheme } from "@mantine/core";
...
export default function FinanceHeader() {
  ...
  return <Group h="100%" w="100%" bg={backgroundColor}>
    <Group align="center" gap={0} w={250} justify="center">
      <ThemeIcon color="var(--mantine-color-text)" size="xl" variant="transparent">
        <IconCurrencyDollar />
      </ThemeIcon>
